...
namespace rm_auto_aim
{
    ...
    public:
        ...
        void run(cv::Mat &img, int color_label);
        ...
        bool containLight(const Light &light_1, const Light &light_2, const std::vector<Light> &lights) const;
        void drawResults(cv::Mat &img) const;
        void showDebuginfo(cv::Mat &img, const Armor &armor) const;
